...
{
	buffer[0] = pgm_read_byte(Hexidecimal + (number >> 12));
	buffer[1] = pgm_read_byte(Hexidecimal + ((number >> 8) & 0x000F));
	buffer[2] = pgm_read_byte(Hexidecimal + ((number >> 4) & 0x000F));
	buffer[3] = pgm_read_byte(Hexidecimal + (number & 0x000F));
	buffer[4] = '\0';
	return buffer;
}
