...
MAKE_MENU(m_s1i2,	m_s1i3,		m_s1i1,			NULL_ENTRY,		m_s2i1,		0,					LNG_MENU_ITEM_SETTINGS);
	...
	MAKE_MENU(m_s2i2,	m_s2i3,		m_s2i1,			m_s1i2,			m_s3i1,			0,	LNG_MENU_ITEM_SETTINGS_CLOCK);
		...
		MAKE_MENU(m_s3i2,	m_s3i3,		m_s3i1,			m_s2i2,			NULL_ENTRY,		MENU_ACTION_DATETIME_SET_TIME,	LNG_MENU_ITEM_SETTINGS_CLOCK_TIME_SETUP);
		MAKE_MENU(m_s3i3,	m_s3i4,		m_s3i2,			m_s2i2,			NULL_ENTRY,		MENU_ACTION_DATETIME_SET_DATE,	LNG_MENU_ITEM_SETTINGS_CLOCK_TIME_DATE);
		MAKE_MENU(m_s3i4,	NULL_ENTRY,	m_s3i3,			m_s2i2,			NULL_ENTRY,		0,								LNG_MENU_ITEM_SETTINGS_CLOCK_TIME_CAL);
	//					NEXT,		PREVIOUS		PARENT,			CHILD
